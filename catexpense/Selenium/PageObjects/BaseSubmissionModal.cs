...
{
    public class BaseSubmissionModal : PageObjectBase
    {
        ...
        public BaseSubmissionModal(IWebDriver driver)
            : base(driver)
        {
        }

        public BaseSubmissionModal ChangeSubmissionType(SubmissionType type)
        {
        ...
        public BaseSubmissionModal ClickPolicy()
        {
